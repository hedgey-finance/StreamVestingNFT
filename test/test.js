...
const { delegateTests, subDelegateTests } = require('./tests/delegateTests');
...
// describe('Testing the vesting contract for revoking NFTs', () => {
//   const amountParamsMatrix = [
//     {amount: C.E18_100, rate: C.E18_1},
//     {amount: C.E18_1000, rate: C.E18_13},
//     {amount: C.E18_10000, rate: C.E18_3},
//     {amount: C.randomBigNum(18, 2500, 100), rate: C.randomBigNum(18, 100, 7)},
//   ];
//   const timeParamsMatrix = [
//     {startShift: 0, cliffShift: 0, unlockShift: 0, timeShift: 1},
//     {startShift: 0, cliffShift: 0, unlockShift: 10, timeShift: 1},
//     {startShift: -500, cliffShift: -250, unlockShift: 0, timeShift: 10},
//     {startShift: 50, cliffShift: 120, unlockShift: 300, timeShift: 75}
//   ];

//   amountParamsMatrix.forEach((amountParam) => {
//     timeParamsMatrix.forEach((timeParam) => {
//       revokeTest(amountParam, timeParam, true);
//       revokeTest(amountParam, timeParam, false);
//     });
//   });
//   revokeErrorTests()
// });
